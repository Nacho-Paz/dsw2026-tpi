        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AvailabilityRule_Month", "[Month] BETWEEN 1 AND 12");
                    table.CheckConstraint("CK_AvailabilityRule_Start_End", "[StartTime] < [EndTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AvailabilitySlot_Start_End", "[StartTime] < [EndTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityRules_DoctorId_Year_Month_DayOfWeek",
